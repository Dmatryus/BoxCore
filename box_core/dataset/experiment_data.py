...
from .executor_state import DatasetSpace, ExecutorState
...
class ExperimentData:
    def __init__(self, data: Dataset):
        ...
        self._index: Dict[DatasetSpace, Dict] = {
            DatasetSpace.additional_fields: {},
            DatasetSpace.variables: {},
            DatasetSpace.groups: {},
            DatasetSpace.analysis_tables: {},
        }
    ...
    def get_value(self, executor_state: Union[ExecutorState, str]):
        return self._data.get(str(executor_state))
